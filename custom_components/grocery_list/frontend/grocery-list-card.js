    ...
    `}_renderItem(e,t,i){if(this._editingId===xe(e))return D`<li class="gl-item">${this._renderEdit(e,t,i)}</li>`;const n=this._qtySwipe,r=e.qty&&n?.slug===t&&xe(n.item)===xe(e)&&n.unit===e.qty.unit?n.previewValue:e.qty?.value,s=e.qty?`${this._fmtNum(r??e.qty.value)} ${this._unitLabel(e.qty.unit,r??e.qty.value)}`:"",a=n?.slug===t&&xe(n.item)===xe(e)&&n.pulseKey?" gl-qty-pulse gl-qty-pulse-"+n.pulseKey%2:"",o=!!e.qty&&this._canQuickAdjustQty(e.qty.unit);return D`
      <li class="gl-item ${e.checked?"checked":""}${a}">
        ...
        <div
          ...
          @lostpointercapture=${e=>this._handleQtyLostPointerCapture(e)}
        >
